...
This is my post-grad learning log to build strong software engineering and machine learning skills while also expanding my knowledge of [adjacent technologies](http://www.effectiveengineer.com/blog/master-adjacent-disciplines) a little bit [everyday](https://jamesclear.com/continuous-improvement).

**Updated**: Once a month | **Current** **Focus**: Math, Machine Learning and Generative AI

## Current Learning
|Resource|Progress|
|---|---|
|[EdX: How to Learn Math](https://learning.edx.org/course/course-v1:StanfordOnline+GSE-YEDUC115-S+1T2020/home)|✅|
